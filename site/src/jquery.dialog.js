// This is a slightly modified version of Futon's jquery.dialog.js
...
(function($) {
  ...
  $.showDialog = function (urlOrTemplate, options) {
    options = options || {};
    ...
    function showDialogWithHTML (html) {
    ...
    if (typeof urlOrTemplate == "string")
      $.get(urlOrTemplate, showDialogWithHTML);
    else {
      options.context = options.context || {};
      showDialogWithHTML(urlOrTemplate(options.context));
    }
  }
