...
-export([getwork_method/0, sendwork_method/0, share_target/0, encode_workunit/1, analyze_result/1, make_reply/1, post_workunit/0, send_result/1, get_first_transaction_branches/1]).
